...
class ErrorTests extends AbstractTest {
	...
	def "Test cicsBundle extension missing #propertiesToRemove"(List<String> propertiesToRemove, List<String> expectedMessages) {
		...
		["url", "region", "bunddef", "csdgroup", "username", "password"] | [DeployBundleTask.MISSING_URL, DeployBundleTask.MISSING_REGION, DeployBundleTask.MISSING_BUNDDEF, DeployBundleTask.MISSING_CSDGROUP, DeployBundleTask.MISSING_USERNAME, DeployBundleTask.MISSING_PASSWORD, DeployBundleTask.DEPLOY_CONFIG_EXCEPTION]
	}
}